...
echo "***** Now running test_once in https://github.com/lupyuen/nuttx-riscv64/blob/main/special-qemu-riscv-nsh64.sh"
...
#       run:  |
    ...
    #   with:
    #     tag_name: special-qemu-riscv-nsh64-${{ steps.date.outputs.date }}
    #     draft: false
    #     prerelease: false
